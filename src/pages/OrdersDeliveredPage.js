...
//         // Refresh the orders by fetching the updated data
//         fetchOrders(currentPage, "Delivered");
//       } else {
...
//   };
  ...
  useEffect(() => {
    const status = "Delivered"; // We're fetching delivered orders
  ...
  const filterOrders = (orders) => {
    return orders.filter((order) => {
      ...
      const matchesDeliveredStatus = order.status === "Delivered"; // Filter by "Delivered" status
