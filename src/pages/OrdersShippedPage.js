...
//         fetchOrders(currentPage, "Shipped");
//       } else {
...
//   };
  ...
  useEffect(() => {
    const status = "Shipped"; // We're fetching delivered orders
  ...
  const filterOrders = (orders) => {
    return orders.filter((order) => {
      ...
      const matchesDeliveredStatus = order.status === "Shipped"; // Filter by "Delivered" status
